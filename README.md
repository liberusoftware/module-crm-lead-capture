...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-lead-capture?sort=semver)](https://github.com/liberusoftware/module-crm-lead-capture/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-lead-capture/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-lead-capture/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-lead-capture
```
...
<a href="https://github.com/liberusoftware/module-crm-lead-capture/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-lead-capture" alt="Contributors to liberusoftware/module-crm-lead-capture">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-lead-capture/graphs/contributors).
